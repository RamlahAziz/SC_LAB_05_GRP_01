...
public class SocialNetworkTest {
    ...
    public void testGuessFollowsGraphUsernameDifferentCases(){
        ...
        followsGraph = SocialNetwork.guessFollowsGraph(Arrays.asList(tweet4, tweet5, tweet6));
        assertTrue(followsGraph.get("randomuser").contains("test1"));
    }
    ...
    public void testInfluencersSingleTweetnoInfluence(){
        ...
        List<String> influencers= SocialNetwork.influencers(followsGraph);
        assertTrue("expected empty set", influencers.isEmpty());
